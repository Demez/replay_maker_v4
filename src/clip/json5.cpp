...
static EJsonError Json_ParseQuote( const char*& str, char endChar, json_str_t& output )
{
	str++;
...
static EJsonError Json_ParseString( const char*& str, json_str_t& output )
{
	const char* base = str;
...
static EJsonError Json_ParseStringNoCheck( const char*& str, json_str_t& output )
{
	const char* base = str;
